...
export const siteContent = {
  ...
  epigraph: {
    paragraphs: [
      ...
      "Therefore, an autopoietic machine is a homeostatic (or rather a relations-static) system which has its own organization (defining network of relations) as the fundamental variable which it maintains constant. This is to be clearly understood. Every unity has an organization specifiable in terms of static or dynamic relations between elements, processes, or both. Among these possible cases, autopoietic machines are unities whose organization is defined by a particular network of processes (relations) of production of components, the autopoietic network, not by the components themselves or their static relations. Since the relations of production of components are given only as processes, if the processes stop, the relations of production vanish; as a result, for a machine to be autopoietic, its defining relations of production must be continuously regenerated by the components which they produce. Furthermore, the network of processes which constitute an autopoietic machine is a unitary system in the space of the components that it produces and which generate the network through their interactions.",
    ] as string[],
  ...
  books: {
    ...
    {
      title: "Extremophiles for a Sustainable Future",
      subtitle: "",
      author: "Masahiro Ito, Issay Narumi, Noriyuki Doukyu (eds.)",
      cover: "/covers/extremophiles-for-a-sustainable-future.jpg",
    },
    {
